...
const projects = [
    ...
    {
        id: 4,
        title: "Manu Singh - Interrogation",
        tagline: "Movie Promotion",
        description: "Launched a strategic social media campaign for new actor Manu Singh promoting the movie 'Interrogation', achieving massive reach and raising IMDB rating from 5.2 to 7.7 organically.",
        imageUrl: "/campaign_interrogation.png",
        accentColor: "#8B5CF6",
        metrics: [
            { value: "1.6M", label: "Total Reach", color: "#8B5CF6" },
            { value: "1.2M", label: "Impressions", color: "#FFFF00" },
            { value: "2M+", label: "Phase 2 Views", color: "#22C55E" },
            { value: "7.7", label: "IMDB Rating", color: "#FF4D8C" },
        ],
        highlights: [
            "IMDB rating boosted from 5.2 to 7.7",
            "Viral page promotion on Instagram & Facebook",
            "Mumbai, Delhi, Bangalore top engagement hubs",
            "Overwhelmingly positive audience sentiment",
        ],
    },
];
