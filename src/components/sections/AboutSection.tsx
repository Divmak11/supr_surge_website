...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="relative py-24 bg-gradient-to-br from-neutral-light to-white overflow-hidden">
      {/* Floating Elements */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-extrabold text-neutral-dark mb-6">
            ...
            <motion.span
              ...
              className="inline-block ml-4 text-highlight-pink"
            >
              👋
            </motion.span>
          </h2>
        ...
        >
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="bg-white rounded-2xl p-6 text-center shadow-lg border-2 border-dashed border-primary-purple/20 hover:border-primary-purple/60 transition-all duration-300"
            >
              <div className="flex justify-center mb-3">
                <div className="w-12 h-12 bg-gradient-to-br from-primary-purple to-accent-green rounded-xl flex items-center justify-center">
                  <stat.icon className="w-6 h-6 text-white" />
                </div>
              </div>
              <div className="text-3xl font-extrabold text-neutral-dark mb-1">
                {stat.value}
              </div>
          ...
          {teamMembers.map((member, index) => (
            ...
            >
              <motion.div
                ...
                className="bg-white rounded-3xl p-8 shadow-xl border border-primary-purple/20 hover:border-primary-purple/60 transition-all duration-300 h-full relative overflow-hidden"
              >
                {/* Floating Emoji */}
                <motion.div
                  animate={{ 
                  ...
                  className="absolute -top-3 -right-3 text-3xl bg-white rounded-full w-12 h-12 flex items-center justify-center shadow-lg border-2 border-accent-green"
                >
                  {member.emoji}
                </motion.div>
                ...
                <div className="text-center mb-6">
                  <motion.div
                    ...
                    className="text-6xl mb-4 inline-block bg-gradient-to-br from-primary-purple/10 to-accent-green/10 rounded-full w-20 h-20 flex items-center justify-center"
                  >
                    {member.avatar}
                  </motion.div>
                ...
                {/* Expertise */}
                <div className="mb-6">
                  <h4 className="text-xs font-bold text-neutral-dark mb-3 uppercase tracking-wide">
                    Expertise
                  </h4>
                  <div className="flex flex-wrap gap-2">
                    {member.expertise.map((skill, idx) => (
                      <motion.span
                        ...
                        viewport={{ once: true }}
                        className="px-3 py-1 bg-primary-purple/10 text-primary-purple text-xs rounded-full font-medium"
                      >
                        {skill}
                      </motion.span>
                    ))}
                ...
                {/* Fun Fact */}
                <div className="bg-gradient-to-r from-accent-green/10 to-highlight-pink/10 rounded-xl p-4 border-l-4 border-accent-green">
                  <h4 className="text-xs font-bold text-neutral-dark mb-2 flex items-center">
        ...
        >
          <div className="bg-gradient-to-r from-primary-purple/10 to-accent-green/10 rounded-3xl p-12 border-2 border-dashed border-primary-purple/30">
            <motion.div
            ...
            <h3 className="text-3xl font-extrabold text-neutral-dark mb-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-highlight-pink to-primary-purple text-white px-8 py-4 rounded-full font-bold text-lg hover:shadow-lg transition-all duration-300"
            >
