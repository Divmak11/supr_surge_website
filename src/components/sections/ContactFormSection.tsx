    ...
    return (
      <section id="contact" className="relative py-24 bg-white overflow-hidden">
        ...
        >
          ...
          <p className="text-2xl text-neutral-medium mb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="relative bg-gradient-to-br from-primary-purple/10 to-accent-green/10 rounded-3xl p-8 border-2 border-dashed border-primary-purple/30"
            >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border border-primary-purple/20"
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              {/* Name Field */}
              <div>
                <label className="flex items-center space-x-2 text-lg font-semibold text-neutral-dark mb-3">
                ...
                <motion.input
                  ...
                  className={`w-full px-6 py-4 rounded-2xl border-2 transition-all duration-300 focus:outline-none ${
                    errors.name
                ...
                {errors.name && (
                  <motion.p
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className="text-error-red text-sm mt-2"
                  >
                    {errors.name}
                  </motion.p>
                )}
              ...
              <div>
                ...
                <motion.textarea
                  ...
                  rows={4}
                  className={`w-full px-6 py-4 rounded-2xl border-2 transition-all duration-300 focus:outline-none resize-none ${
                    errors.goals
                      ? "border-error-red bg-error-red/5"
                      : focusedField === "goals"
                      ? "border-primary-purple bg-primary-purple/5"
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="w-full bg-gradient-to-r from-primary-purple to-accent-green text-white py-6 rounded-2xl font-bold text-lg transition-all duration-300 hover:shadow-lg disabled:opacity-70 disabled:cursor-not-allowed"
              >
                <span className="flex items-center justify-center space-x-2">
                  {isSubmitting ? (
                    <>
